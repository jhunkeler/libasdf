...
const unsigned char *ASDF_YAML_DIRECTIVE_PREFIX = "%YAML ";
const unsigned char *ASDF_YAML_DIRECTIVE = "%YAML 1.1";
const unsigned char *ASDF_YAML_DOCUMENT_END_MARKER = "\n...";


const asdf_parse_token_t asdf_parse_tokens[] = {
    [ASDF_YAML_DIRECTIVE_TOK] = {"%YAML ", ASDF_YAML_DIRECTIVE_PREFIX_SIZE},
    [ASDF_YAML_DOCUMENT_END_TOK] = {"\n...", ASDF_YAML_DOCUMENT_END_MARKER_SIZE},
